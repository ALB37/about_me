...
if (answer3 === '') {
  ...
  console.log('User changed answer 3 to ' + answer3);
}
...
if (answer4 === '') {
  alert('Come on, a simple yes or no will suffice!');
  answer4 = prompt('Am I interested in analog photography?').toLowerCase();
  console.log('User changed answer 4 to ' + answer4);
}
...
if (answer5 === '') {
  alert('Come on, a simple yes or no will suffice!');
  answer5 = prompt('Do I have an interest in synthesizers?').toLowerCase();
  console.log('User changed answer 5 to ' + answer5);
}
if ((answer5 === 'y') || (answer5 === 'yes')) {
  alert('Totally! Synthesizers are the coolest. I\'d love to build a modular system someday.');
} else {
  alert('I really do love them though.');
}
